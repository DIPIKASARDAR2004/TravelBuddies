...
export default function BudgetCalculator({ selectedType }: { selectedType: string | null }) {
  ...
  return (
    <div className="p-6 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl shadow-lg max-w-lg mx-auto">
      <h2 className="text-2xl font-bold text-purple-800 mb-4">💰 Budget Calculator</h2>
      ...
      <input
        ...
        className="w-full px-3 py-2 mb-3 border rounded-lg focus:ring-2 focus:ring-purple-400"
      />
      ...
      <div className="flex gap-3 mb-3">
        <input
          ...
          className="flex-1 px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-400"
        />
        <input
          type="number"
          ...
          <ul className="space-y-2">
            {results.map((stay) => (
              ...
              >
                ...
                <span className="font-bold text-purple-700">₹{stay.price}</span>
              </li>
            ))}
          </ul>
        ) : (
