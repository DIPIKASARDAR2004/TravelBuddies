    ...
    <div className="mt-12 space-y-8">
      ...
      <div className="space-y-6">
        {itinerary.map((day, idx) => {
          ...
          return (
            <div key={idx} className="glass-panel premium-shadow rounded-2xl overflow-hidden transition-all duration-300">
              {/* Day Header */}
              <button 
                          ...
                          return (
                            <React.Fragment key={`act-${actIdx}`}>
                              ...
                              <div className="relative flex items-start gap-4 md:gap-6">
                                ...
                                <div className="flex-1 bg-white dark:bg-slate-800/80 p-4 rounded-2xl border border-slate-100 dark:border-slate-700/50 shadow-sm hover-shadow transition-shadow group">
